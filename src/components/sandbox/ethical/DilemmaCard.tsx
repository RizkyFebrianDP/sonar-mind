  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className="bg-panel rounded-3xl p-8 border border-sidebar-border shadow-sm"
      >
        {/* Ikon & Label */}
        ...
        {/* Situasi Teks */}
        <p className="text-lg font-medium text-text-strong leading-relaxed mb-8 min-h-[80px]">
